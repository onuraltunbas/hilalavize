...
export const COMPANY_DATA = {
  ...
  branches: [
    {
      id: "avize-showroom",
      name: "Hilal Avize ve Aksesuar Showroom Şubesi",
      shortName: "Avize ve Dekorasyon Showroom",
      type: "showroom",
      headline: "Lüks Avize, Aydınlatma ve Özel Dekorasyon Koleksiyonları",
      description:
      ...
      contacts: [
        {
          ...
          role: "Showroom ve Aydınlatma Danışmanı",
          phone: "+905053801350",
      ...
      features: [
        "1. Sınıf K9 ve Asfour Kristal Cam Kalitesi",
        "Evinize ve Mekanınıza Özel Ücretsiz Aydınlatma Danışmanlığı",
        "Kırılmaya Karşı %100 Güvenceli Özenli Nakliye",
        "Uzman Ekiple Güvenli Montaj Hizmeti",
        "İhtişamlı Klasik ve Modern Geniş Ürün Yelpazesi",
      ],
    ...
    {
      id: "elektrik-sube",
      name: "Hilal Elektrik ve Tesisat Malzemeleri Şubesi",
      shortName: "Elektrik ve Tesisat Şubesi",
      type: "electrical",
      headline: "Toptan ve Perakende Elektrik Malzemeleri ve Profesyonel Uygulama",
      description:
        "Tüm elektrik malzemeleri, lüks anahtar ve priz serileri, sigorta kutuları, kablo ve aydınlatma armatürleri satışı ile profesyonel montaj, anahtar teslim tesisat, profesyonel usta ve işçilik hizmetleri sunuyoruz.",
      address: {
      ...
      contacts: [
        {
          name: "Elektrik ve Proje Ekibi",
          role: "Elektrik ve Proje Sorumlusu",
          phone: "+905559778349",
      ...
      features: [
        "Lüks Cam ve Metal Çerçeveli Anahtar-Priz Serileri",
        "TSE ve CE Belgeli Orijinal Elektrik Malzemeleri",
        "Profesyonel Elektrik Montajı, Priz ve Sigorta Değişimi",
  ...
  trustBadges: [
    ...
    {
      title: "Özenli Nakliye ve Güvenli Montaj",
