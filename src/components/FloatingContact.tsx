  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
            ...
            <div className="bg-surface-subtle p-3.5 rounded-lg border border-border">
              ...
              <div className="pt-1">
                <a
                  ...
                  className="bg-[#1D7E45] hover:bg-[#17693a] text-white text-xs font-bold py-2.5 px-3 rounded-lg flex items-center justify-center gap-2 transition-colors shadow-sm w-full"
                >
      ...
      <button
        ...
        className="group relative flex items-center gap-2.5 bg-[#1D7E45] hover:bg-[#17693a] text-white font-bold px-4 py-3 rounded-full shadow-lg border border-emerald-400/30 transition-all transform hover:scale-105"
      ...
      >
        ...
        <span className="text-xs tracking-wide pr-0.5">Teklif Al</span>
      </button>
    </div>
  );
}
